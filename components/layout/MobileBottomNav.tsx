  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 border-t-brutal border-brutal-border bg-brutal-black z-40 pb-safe">
      <div className="flex items-center justify-around h-16">
        ...
        <div className="flex flex-col items-center justify-center w-full h-full min-h-[44px] min-w-[44px]">
          <NotificationBell />
          <span className="text-[10px] font-heading font-bold uppercase tracking-wider mt-1 text-brutal-text-secondary">Alerts</span>
        </div>
